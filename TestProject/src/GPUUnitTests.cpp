...
namespace GPUUnitTests
{
    ...
    namespace UtilTest
    {
        ...
        TEST(GPU_UtilTest, RuntimeTest_Grid_From_Pos)
        {
            unsigned int n = 1;
        ...
        TEST(GPU_UtilTest, RuntimeTest_Cell_From_Grid)
        {
            unsigned int n = 1;
            FlockSystem flockSys(n,10.0f,0.1f,dt,res);
            flockSys.init();
        ...
        TEST(GPU_UtilTest, RuntimeTest_Distance_Squared)
        {
            unsigned int n = 1;
            FlockSystem flockSys(n,10.0f,0.1f,dt,res);
            flockSys.init();
        ...
        TEST(GPU_UtilTest, RuntimeTest_Rotate_Vector_About_Z)
        {
            unsigned int n = 1;
            FlockSystem flockSys(n,10.0f,0.1f,dt,res);
            flockSys.init();
    ...
    namespace BoidTest
    {
        ...
        TEST(GPU_BoidTest, RuntimeTest_Hashing_and_Boid_Spawn)
        {
            uint n = 100;
            FlockSystem flockSys(n,10.0f,0.1f,dt,res);
        ...
        TEST(GPU_BoidTest, RuntimeTest_Neighbourhood_and_Collision)
        {
            unsigned int n = 1000;
            uint numCollision = 0;
            FlockSystem flockSys(n,10.0f,0.1f,dt,res);
        ...
        TEST(GPU_SteeringTest, RuntimeTest_Integrator)
        {
            unsigned int n = 1;
        ...
        TEST(GPU_SteeringTest, RuntimeTest_Seek)
        {
            unsigned int n = 1;
            /// let's make the timestep bigger for testing numbers
            float mass = 10.0f;
        ...
        TEST(GPU_SteeringTest, RuntimeTest_Flee)
        {
             unsigned int n = 1;
            float mass = 10.0f;
            FlockSystem flockSys(n,mass,0.1f,dt,res);
        ...
        TEST(GPU_SteeringTest, RuntimeTest_Wander)
        {
            unsigned int n = 1;
            float mass = 10.0f;
            FlockSystem flockSys(n,mass,0.1f,dt,res);
